...
function config.legendary()
	...
	require("which-key").register({
		...
		["<C-p>"] = "find: File under current work directory",
		["<leader>G"] = "git: Show fugitive",
		["<leader>g"] = "git: Show gitui",
		...
		["<leader>sp"] = "edit: Check spell",
		["<leader>o"] = "Telescope: Show lsp document symbols",
		["<leader>as"] = "Telescope: Show lsp dynamic workspace symbols",
