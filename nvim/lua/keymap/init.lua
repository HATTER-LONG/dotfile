...
local plug_map = {
    ...
    ["n|<leader>fp"]        = map_cu("lua require('telescope').extensions.projects.projects{}"):with_noremap():
        with_silent(),
    ["n|<leader>fr"]        = map_cu("lua require('telescope').extensions.frecency.frecency{}"):with_noremap():
        with_silent(),
    ...
    -- Plugin Legendary
    ["n|<C-S-p>"]           = map_cr("Legendary"):with_silent():with_noremap(),
}
